...
class StringProcessor {
  static String toOrdStr(List<int> codes) {
  ...
  static List<int> toCharArray(String s) {
    return s.codeUnits;
  }
...
class CryptoUtility {
  final String salt;
  final List<String> customBase64Alphabet;
  late List<int> bigArray;

  CryptoUtility(this.salt, this.customBase64Alphabet) {
    bigArray = [
      121,
      243,
      55,
  ...
  String base64Encode(String inputString, {int selectedAlphabet = 0}) {
    ...
    var outputString = base64Indices
        .map((index) => customBase64Alphabet[selectedAlphabet][index])
        .join('');
  ...
  String abogusEncode(String abogusBytesStr, int selectedAlphabet) {
    final abogus = <String>[];
    final alphabet = customBase64Alphabet[selectedAlphabet];
